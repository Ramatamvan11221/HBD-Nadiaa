...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('Sept 28, 2025 00:00:00').getTime(),
...
new TypeIt("#teks1", {
  strings: [
    "Selamat ulang tahun Naddd!! 🥳🎂🎉",
    "Semoga panjang umur dan selalu diberi kesehatan 💪✨",
    "Makin pinter sekolahnya, makin rajin belajar 📚",
    "Dan semoga jadi juara kelas terus yaa 🏆🔥",
    "Doa terbaik biar bisa lolos masuk ITB juga 🤩🎓",
    "Tetap semangat, jangan gampang nyerah 💪",
    "Terus jadi kebanggaan Kakek dan Nenek ya 💖",
    "Have an amazing birthday, Nad!! 🎉🎈✨"
  ],
  startDelay: 4000,
  speed: 70,
...
new TypeIt("#teks2", {
  strings: [
    "Semoga hari-harimu selalu penuh cinta dan kebahagiaan 💐🫶",
    "Semoga setiap langkahmu dimudahkan menuju impianmu ✨",
    "Terus tumbuh jadi pribadi yang kuat dan rendah hati 🌸",
    "Barakallah fii umrik, Nad 💖",
